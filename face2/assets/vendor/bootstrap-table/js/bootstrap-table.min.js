...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('，每一页显示 %s 个', pageNumber);
        },
        formatShowingRows: function (totalRows) {
            return sprintf('共 %s 个结果', totalRows);
        },
            ...
            $.each(columns, function (j, column) {
                ...
                if (column.checkbox) {
                    ...
                    if (!that.options.singleSelect && that.options.checkboxHeader) {
                        text = '<div class="table-checkbox"><input name="btSelectAll" type="checkbox"  class="table-checkbox-input"/><label class="table-checkbox-label"></label></div>';
                    }
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push(
            ...
            this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) :
                this.options.formatShowingRows(this.options.totalRows),
            '</span>');
    ...
    BootstrapTable.prototype.initRow = function (item, i, data, parentDom) {
        ...
        $.each(this.header.fields, function (j, field) {
            ...
            if (column.checkbox) {
                ...
                '<div class="table-checkbox"><input' +
                sprintf(' data-index="%s"', i) +
                ...
                ' class="table-checkbox-input" /><span class="table-checkbox-label"></span></div>',
                ...
                sprintf(' disabled="%s"', !column.checkboxEnabled ||
                    (value && value.disabled) ? 'disabled' : undefined) +
                ' class="table-radio-input" /><span class="table-radio-label"></span></div>',
                that.header.formatters[j] && typeof value === 'string' ? value : '',
                that.options.cardView ? '</div>' : '</td>'
                ].join('');
