    ...
    $.fn.extend({
        whjPaging: function(b, r) {
            ...
            if (b === "getPage") {
                ...
                if (b === "setPage") {
                    g.get(0).pageText.currPage = r.currPage ? r.currPage : g.get(0).pageText.currPage ;
                    g.get(0).pageText.totalPage = r.totalPage ? r.totalPage : g.get(0).pageText.totalPage ;
                    g.get(0).pageText.totalSize = r.totalSize ? r.totalSize : g.get(0).pageText.totalSize ;
            ...
            function u() {
                ...
                var pageSizeOpt = g.get(0).pageText.pageSizeOpt,
                    selectPageSizeOpt;
                for (var i = 0; i < pageSizeOpt.length; i++) {
                    if (pageSizeOpt[i].selected) {
                        selectPageSizeOpt = pageSizeOpt[i].value;
                    }
                }
                g.get(0).pageText.callBack(g.get(0).pageText.currPage, g.get(0).pageText.pageSize, g, selectPageSizeOpt)
            }
